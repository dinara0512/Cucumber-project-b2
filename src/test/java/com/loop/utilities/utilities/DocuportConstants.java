...
public class DocuportConstants {
    ...
    public static final String ERROR_MESSAGE_FOR_EMPTY_PASSWORD = "";
    ...
    public static final String VALID_PASSWORD = "Group1";
    public static final String CLIENT_HOME_PAGE = "https://beta.docuport.app/ ";

    public static final String DOCUPORT_PAGE = "https://beta.docuport.app/login";
